// Versao FINAL - Textos ajustados + Acentos corretos
// Cole no Console (F12) apos login

(function () {
    // Icones SVG refinados
    const icons = {
    ...
    // CSS para ajustar textos aos cards menores
    const style = document.createElement('style');
    style.textContent = `
        /* Cards de documentos - layout otimizado */
        .doc-card {
    ...
    console.log('✅ Textos ajustados para cards menores');
    console.log('✅ Todos os acentos corretos');
    console.log('✅ Layout harmonioso e organizado');
})();
