// Versao corrigida - SEM problema de encoding
// Cole no Console (F12) apos login e ir em Administracao
...
(function () {
    ...
    if (!adminContent) {
        alert('Va para Administracao primeiro!');
        return;
    }
    ...
    adminContent.innerHTML = `
        <div id="statsView" class="admin-sub-view" style="display: block;">
            <section class="stats-section">
                ...
                <div class="stats-grid">
                    ...
                    <div class="stat-card">
                        <div class="stat-icon">👥</div>
                        <div><div class="stat-value" id="totalUsers">0</div><div class="stat-label">Usuarios</div></div>
                    </div>
                </div>
            </section>
            ...
            <section class="manage-section">
                ...
                <div class="stats-grid" style="grid-template-columns: repeat(auto-fit, minmax(280px, 1fr));">
                    ...
                    <div class="admin-nav-card" onclick="document.getElementById('statsView').style.display='none'; document.getElementById('usersView').style.display='block'; renderAdminUsers();">
                        ...
                        <div>
                            <div class="stat-label" style="font-size: 1.125rem; font-weight: 600;">Usuarios</div>
                            <div class="help-text">Cadastrar e gerenciar usuarios</div>
                        </div>
                    </div>
                    <div class="admin-nav-card" onclick="document.getElementById('statsView').style.display='none'; document.getElementById('logsView').style.display='block'; renderLogs();">
                        ...
                        <div>
                            ...
                            <div class="help-text">Historico completo de acoes</div>
                        </div>
                    </div>
                </div>
            </section>
        ...
        <div id="usersView" class="admin-sub-view" style="display: none;">
            ...
            <div class="view-header">
                ...
                <p>Cadastrar usuarios e configurar permissoes</p>
            </div>
            <div style="margin-bottom: 1.5rem;">
                <button class="btn-primary" onclick="openAddUserModal()">➕ Adicionar Usuario</button>
            </div>
        ...
        <div id="logsView" class="admin-sub-view" style="display: none;">
            ...
            <div class="view-header">
                ...
                <p>Historico completo de todas as acoes realizadas no sistema</p>
            </div>
    ...
    // Filtrar historico para mostrar apenas do usuario atual (nao admin)
    ...
    window.renderHistory = function () {
        ...
        // Se nao for admin, mostrar apenas suas proprias reservas
        ...
        container.innerHTML = filtered.slice(0, 50).map(r => `
            <div class="history-item">
                <div class="history-info">
                    ...
                    <div class="history-details">${formatDate(new Date(r.timestamp))} as ${formatTime(new Date(r.timestamp))} - ${r.userName}</div>
                </div>
    ...
    console.log('Interface atualizada SEM problemas de encoding!');
    console.log('3 cards: Documentos, Usuarios, Logs');
    console.log('Historico filtrado por usuario');
})();
