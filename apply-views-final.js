// Versão FINAL - Com ícones SVG nas estatísticas também
// Cole no Console (F12) após login e ir em Administração
...
(function () {
    const icons = {
        ...
        stats: '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="20" x2="18" y2="10"></line><line x1="12" y1="20" x2="12" y2="4"></line><line x1="6" y1="20" x2="6" y2="14"></line></svg>',
        number: '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="4" y1="9" x2="20" y2="9"></line><line x1="4" y1="15" x2="20" y2="15"></line><line x1="10" y1="3" x2="8" y2="21"></line><line x1="16" y1="3" x2="14" y2="21"></line></svg>',
        calendar: '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>',
        team: '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>'
    };
        ...
        <div id="statsView" class="admin-sub-view" style="display: block;">
            <section class="stats-section">
                ...
                <div class="stats-grid">
                    ...
                    <div class="stat-card">
                        <div class="stat-icon">${icons.number}</div>
                    ...
                    <div class="stat-card">
                        <div class="stat-icon">${icons.team}</div>
    ...
    // Filtrar histórico para mostrar apenas do usuário atual (não admin)
    ...
    window.renderHistory = function () {
        ...
        // Se não for admin, mostrar apenas suas próprias reservas
    ...
    console.log('✅ Interface atualizada com ícones SVG nas estatísticas!');
    console.log('✅ 3 cards de navegação: Documentos, Usuários, Logs');
    console.log('✅ Histórico filtrado por usuário');
})();
